...
from sgl.models.homo.gda import SampleFLAG
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_path", type=str, default="./configs/SampleFLAG.yml", help="save path of the configuration file"
    )
    ...
    model = SampleFLAG(training_sampler, eval_sampler, in_dim=dataset.num_features, n_classes=dataset.num_classes, **model_kwargs)
