...
class Imdb(HeteroNodeDataset):
    ...
    def __init__(self, root="./", split="official"):
        name = 'imdb'
        # This dataset is processed based on the output of IMDBDataset
        self.src_dataset = IMDB(root=root).data

        super(Imdb, self).__init__(root, name)
    ...
    def raw_file_paths(self):
        filepath = self._name + "/raw/geometric_data_processed.pt"
